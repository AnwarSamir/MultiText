...
import pooredit.beans.ElementBean;
import pooredit.utils.Constants;
...
public class EditView extends LinearLayout {
    ...
    private pooredit.views.File addFileOn(int index){
        pooredit.views.File file = new pooredit.views.File(getContext());
        ...
        for (LinkedTreeMap<String, Object> bean : beans){
            ...
            switch (type){
                ...
                case Constants.TYPE_ITEM:
                    ...
                    break;
                case Constants.TYPE_ATT:
                   pooredit.views.File fileView = addFileOn((int) Math.round((Double) bean.get("index")));
